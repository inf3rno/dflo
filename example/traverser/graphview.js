    ...
    var GraphView = Class.extend({
        ...
        render: function () {
            ...
            defs.append("path").attr({
                ...
                d: "M246.749,388c-20.343,0-34.153-14.97-34.153-34.938c0-20.688,14.186-34.905,34.153-34.905c20.688,0,34.125,14.217,34.562,34.905C281.312,373.03,267.875,388,246.749,388zM293.188,244.845c-13.812,15.719-19.937,30.717-19.562,47.968v6.938h-51.063l-0.373-10c-1.159-19.562,5.372-39.532,22.623-59.875c12.313-14.969,22.25-27.625,22.25-40.297c0-13.421-8.812-22.64-28-23.015c-12.656,0-28,4.592-38,11.501l-13.03-41.831c14.186-8.061,36.841-15.734,64.093-15.734c50.624,0,74.063,28.016,74.063,59.875C326.188,209.545,307.75,228.749,293.188,244.845z"
            });
            defs.append("path").attr({
                id: "publisher",
                transform: "translate(-20,-20) scale(0.08)",
